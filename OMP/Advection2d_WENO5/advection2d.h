...
/* WENO constants */
#define D0N ((double)1)/10
#define D1N ((double)6)/10
#define D2N ((double)3)/10
#define D0P ((double)3)/10
#define D1P ((double)6)/10
#define D2P ((double)1)/10
#define EPS 1E-6
#define C1312 ((double)13)/12
#define C14 ((double)1)/4
