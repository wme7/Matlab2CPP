...
#define NX 12 // number of cells in the x-direction
#define NY 12 // number of cells in the y-direction
...
#define SY 2 // sub-grids in the y-direction
...
void Manage_Comms(dmn domain, double **h_u, double **h_u_old);
