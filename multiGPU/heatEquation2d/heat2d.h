...
#define NX 58 // number of cells in the x-direction
#define NY 18 // number of cells in the y-direction
...
#define SNY (NY/YGRID) // subregaion size
...
void Save_Results_Tid(int tid, float *h_u);
